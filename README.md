...
The first step to running Gmail Clone locally is downloading the code by cloning the repository:

```sh
git clone https://github.com/svarcoder/Gmail.git
```
